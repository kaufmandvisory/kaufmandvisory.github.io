...
assert.equal(fiscal.jurisdictions.length, 10, 'unexpected fiscal jurisdiction coverage');
assert.equal(fiscal.events.length, 5, 'unexpected fiscal event coverage');
assert.equal(fiscal.data_quality.fact_count, 50, 'fiscal matrix is incomplete');
