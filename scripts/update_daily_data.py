...
MINING_HARDWARE = [
    {
        ...
        "hashrate_th_s": 270.0,
        "power_w": 3645.0,
        "operating_temperature": "-20–45 °C",
        "noise_db": 76,
        "input_voltage": "220–277 V AC",
        "tolerance": "Hashrate ±3 % · potencia ±5 %",
        "spec_basis": "Valores nominales publicados por el fabricante",
    ...
    },
    {
        ...
        "hashrate_th_s": 473.0,
        "power_w": 5676.0,
        "operating_temperature": "20–50 °C · refrigerante",
        "noise_db": None,
        "input_voltage": "380–415 V AC",
        "tolerance": "Hashrate ±3 % · potencia ±5 %",
        "spec_basis": "Valores nominales publicados por el fabricante",
        "source": "BITMAIN Support",
    ...
    },
    {
        ...
        "noise_db": None,
        "input_voltage": "220–240 V AC",
        "tolerance": "Rendimiento sujeto a variante y condiciones",
        "spec_basis": "Potencia calculada: 226 TH/s × 15,5 J/TH",
        "source": "MicroBT · WhatsMiner",
        "source_url": "https://www.whatsminer.com/src/views/news_detail.html?id=288&title=Lead+Great+and+Green+Mining+Forward+%7C+MicroBT+Unveils+New-Gen+WhatsMiner+M6XS+++Series+at+Bitcoin+MENA+2024",
    },
    {
        "id": "avalon-a15pro",
        "manufacturer": "Canaan",
        "model": "AvalonMiner A15Pro",
        "cooling": "Aire",
        "hashrate_th_s": 221.0,
        "power_w": 3662.0,
        "operating_temperature": "-5–35 °C",
        "noise_db": 75,
        "input_voltage": "Consultar variante y destino",
        "tolerance": "Hashrate ±5 % · potencia ±10 %",
        "spec_basis": "Valores nominales publicados por el fabricante",
        "source": "Canaan Official Shop",
        "source_url": "https://shop.canaan.io/products/",
    },
    {
        "id": "avalon-a16",
        "manufacturer": "Canaan",
        "model": "AvalonMiner A16",
        "cooling": "Aire",
        "hashrate_th_s": 282.0,
        "power_w": 3900.0,
        "operating_temperature": "Consultar ficha de lote",
        "noise_db": None,
        "input_voltage": "Consultar ficha de lote",
        "tolerance": "Especificación sujeta a lote",
        "spec_basis": "Valores nominales publicados por el fabricante",
        "source": "Canaan Official Shop",
        "source_url": "https://shop.canaan.io/products/",
    },
...
MINING_POOL_TERMS = [
    {
        "id": "f2pool",
        "name": "F2Pool",
        "payout_scheme": "FPPS / PPLNS",
        "pool_fee": "4 % FPPS · 2 % PPLNS",
        "minimum_payout": "0,005 BTC por defecto",
        "payout_timing": "Según umbral configurado",
        "source": "F2Pool Help Center",
        "source_url": "https://f2pool.zendesk.com/hc/en-us/articles/360058887912-Mining-pools-info-payout-schemes-and-thresholds-at-f2pool",
    },
    {
        "id": "viabtc",
        "name": "ViaBTC",
        "payout_scheme": "PPS+ / PPLNS",
        "pool_fee": "4 % PPS+ · 2 % PPLNS",
        "minimum_payout": "Depende de configuración",
        "payout_timing": "PPS+ horario; PPLNS tras confirmaciones",
        "source": "ViaBTC Pricing",
        "source_url": "https://www.viabtc.com/en/pricing?lang=en_US",
    },
    {
        "id": "braiins",
        "name": "Braiins Pool",
        "payout_scheme": "FPPS",
        "pool_fee": "2,5 %",
        "minimum_payout": "0,0002 BTC · 0,005 BTC sin comisión onchain",
        "payout_timing": "Diario 09:00 UTC o regla configurada",
        "source": "Braiins Academy",
        "source_url": "https://academy.braiins.com/braiins-pool/rewards-and-payouts",
    },
]
...
def mining_profitability():
    ...
    try:
        ...
        return {
            "status": "auto",
            "asset_scope": "BTC_SHA256",
            "observed_at": observed_at,
            "refresh_policy": {
                "btc_price_target_minutes": 5,
                "network_target_minutes": 30,
                "pools_target_minutes": 30,
                "electricity_source_frequency": "Semestral",
                "hardware_review_frequency": "Revisión primaria fechada; no se presenta como tiempo real",
            },
            "hardware": hardware,
            "hardware_comparison": hardware_comparison,
            "hardware_checked_at": "2026-09-02",
            ...
            "pools": pool_rows[:10],
            "pool_terms": MINING_POOL_TERMS,
            "pool_terms_checked_at": "2026-09-02",
            "pool_window": "7d",
